...
class AbstractDockerRegistryTests(TestCase):
    def setUp(self) -> None:
    ...
    def test_revision_from_tag(self, tag: str, expected_revision: int):
        revision = AbstractDockerRegistry(self.environment).revision_from_tag(tag)
    ...
    def test_tag_from_revision(self, revision, postfix, expected_tag):
        ...
        tag = AbstractDockerRegistry(self.environment).tag_from_revision(revision)
        self.assertEqual(tag, expected_tag)

    @patch.object(AbstractDockerRegistry, "get_repository_uri")
    @patch.object(AbstractDockerRegistry, "create_repository")
    def test_get_or_create_repository_uri__not_found(self, mock_create_repository, mock_get_repository_uri):
        ...
        AbstractDockerRegistry(self.environment).get_or_create_repository_uri("unknown-repo")
    ...
    def test_get_or_create_repository_uri__exists(self, mock_get_repository_uri):
        ...
        uri = AbstractDockerRegistry(self.environment).get_or_create_repository_uri("some-repo")
        self.assertEqual(uri, "some-repo-uri")

    @patch.object(AbstractDockerRegistry, "iter_image_tags")
    def test_get_latest_revision__not_found(self, mock_iter_image_tags):
        mock_iter_image_tags.return_value = []

        revision = AbstractDockerRegistry(self.environment).get_latest_revision("unknown-repo")
    ...
    def test_get_latest_revision(self, mock_iter_image_tags):
        ...
        revision = AbstractDockerRegistry(self.environment).get_latest_revision("some-repo")
    ...
    def test_get_latest_image_uri(self, mock_get_repository_uri, mock_iter_image_tags):
        ...
        image_uri = AbstractDockerRegistry(self.environment).get_latest_image_uri("some-repo")
    ...
    def test_get_latest_image_uri__not_found(self, mock_get_repository_uri, mock_iter_image_tags):
        ...
        registry = AbstractDockerRegistry(self.environment)
